...
# CODUL TĂU VINE MAI JOS:
if number>=10:
    print("the nr is positive, yeey")
else:
    print("the nr is nehative")
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
if text is 'Python':
    print("the text is Python")
else:
    print("the text is not Python")
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
if 'Java' in text:
    print("the word Java is in text")
else:
    print("the word Java is not in text")
# CODUL TĂU VINE MAI SUS:
...
if 'Java' in text:
    ...
    print("the word Python is in text")
else:
    print("the words are not in text")
# CODUL TĂU VINE MAI SUS:
...
if ('Java' in text)and('Python' in text):
    print("the words Java and Python are in text")
else:
    print("the words are not in text")
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
number=int(input('Introduceti un nr de la 1 la 5: '))
